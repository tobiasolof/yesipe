...
# 					Utils.delay 0.5, ->
			...
			bubbles[b].onLongPress ->
				yesipe_test1.put("/altIngredients/request", b)
...
alternateArray = []
	yesipe_test1.onChange "/altIngredients/alternatives", (pos) ->
		tempArray = _.toArray (pos)
...
# 				y: orgY + bubbleSize*1.5
				...
				scale:0.1
				backgroundColor: purple
				circleCoord = arcMovement.circlePoint orgX, orgY, 360/5*a, orgLayer.width*1.2, orgLayer.width*1.2
