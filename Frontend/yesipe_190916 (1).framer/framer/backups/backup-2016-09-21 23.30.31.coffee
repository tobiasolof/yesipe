...
# 					Utils.delay 0.5, ->
			...
			bubbles[b].onLongPress ->
				yesipe_test1.put("/altIngredients/request", suggestionsArray[b]["name"])
				createAlternatives(bubbles[b], bubbles[b].mixX, bubbles[b].y)
...
# 				y: orgY + bubbleSize*1.5
				backgroundColor: purple
			arcMovement.placeOnElipse alternateBubbles[a], orgX, orgY, 360/5*a, 200, 200
